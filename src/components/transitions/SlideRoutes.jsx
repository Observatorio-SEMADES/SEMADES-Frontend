...
const ROUTE_ORDER = ["/home", "/dashboard", "/dashboard/empresas", "/dashboard/empregos", "/dashboard/agro-pecuaria", "/dashboard/agro-agricultura", "/dados-centro", "/superintendencias", "/ferramentas"];
